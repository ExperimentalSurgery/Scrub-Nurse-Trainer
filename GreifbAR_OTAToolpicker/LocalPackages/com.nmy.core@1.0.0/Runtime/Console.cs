...
{ 
    ...
    public class Console : MonoBehaviour
    {
        ...
        /// <summary>
        /// Whether to open the window by drawing a circle gesture.
        /// </summary>
        public bool gestureToOpen = true;
        ...
        void Update()
        {
            ...
            if (gestureToOpen && IsGestureDone()) {
                isVisible = !isVisible;
            }
        }
                ...
                Application.platform == RuntimePlatform.IPhonePlayer )
            {
                ...
                else 
                {
                    ...
                    else if( Input.touches[0].phase == TouchPhase.Moved )
                    {
                        ...
                        if( gestureDetector.Count == 0 ||  (p - gestureDetector[ gestureDetector.Count-1]).sqrMagnitude > 100 )
