...
namespace NMY.VirtualRealityTraining.Editor
{
    public static class ReflectionUtility
    {
        ...
        static Dictionary<object, Dictionary<string, FieldInfo>> fieldInfoDictionary =
            new Dictionary<object, Dictionary<string, FieldInfo>>();
        ...
        static Dictionary<object, Dictionary<string, PropertyInfo>> propertyInfoDictionary =
            new Dictionary<object, Dictionary<string, PropertyInfo>>();
